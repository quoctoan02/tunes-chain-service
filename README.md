...
```
cd existing_repo
git remote add origin https://gitlab.com/moon-lab/core-hunter/core-hunter-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/moon-lab/core-hunter/core-hunter-service/-/settings/integrations)
